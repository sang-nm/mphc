Type.registerNamespace('gbAjaxControlToolkit');

// This is the base behavior for all extender behaviors
gbAjaxControlToolkit.BehaviorBase = function(element) {
    /// <summary>
    ...
    /// </param>
gbAjaxControlToolkit.BehaviorBase.initializeBase(this, [element]);
...
gbAjaxControlToolkit.BehaviorBase.prototype = {
    initialize: function() {
        /// <summary>
    ...
    gbAjaxControlToolkit.BehaviorBase.callBaseMethod(this, 'initialize');
    },
    ...
    dispose: function() {
        ...
        /// </summary>
    gbAjaxControlToolkit.BehaviorBase.callBaseMethod(this, 'dispose');
...
gbAjaxControlToolkit.BehaviorBase.registerClass('gbAjaxControlToolkit.BehaviorBase', Sys.UI.Behavior);


// Dynamically populates content when the populate method is called
gbAjaxControlToolkit.DynamicPopulateBehaviorBase = function(element) {
    /// <summary>
    ...
    /// </param>
gbAjaxControlToolkit.DynamicPopulateBehaviorBase.initializeBase(this, [element]);
...
gbAjaxControlToolkit.DynamicPopulateBehaviorBase.prototype = {
    initialize: function() {
        /// <summary>
        /// Initialize the behavior
        /// </summary>

    gbAjaxControlToolkit.DynamicPopulateBehaviorBase.callBaseMethod(this, 'initialize');
    ...
    populate: function(contextKeyOverride) {
        ...
        if (!this._dynamicPopulateBehavior && this._DynamicControlID && this._DynamicServiceMethod) {
            this._dynamicPopulateBehavior = $create(gbAjaxControlToolkit.DynamicPopulateBehavior,
                {
...
gbAjaxControlToolkit.DynamicPopulateBehaviorBase.registerClass('gbAjaxControlToolkit.DynamicPopulateBehaviorBase', gbAjaxControlToolkit.BehaviorBase);


gbAjaxControlToolkit.ControlBase = function(element) {
gbAjaxControlToolkit.ControlBase.initializeBase(this, [element]);
...
gbAjaxControlToolkit.ControlBase.__doPostBack = function(eventTarget, eventArgument) {
    if (!Sys.WebForms.PageRequestManager.getInstance().get_isInAsyncPostBack()) {
        for (var i = 0; i < gbAjaxControlToolkit.ControlBase.onsubmitCollection.length; i++) {
            gbAjaxControlToolkit.ControlBase.onsubmitCollection[i]();
        }
    }
    Function.createDelegate(window, gbAjaxControlToolkit.ControlBase.__doPostBackSaved)(eventTarget, eventArgument);
}

gbAjaxControlToolkit.ControlBase.prototype = {
    initialize: function() {
    gbAjaxControlToolkit.ControlBase.callBaseMethod(this, "initialize");
        ...
        if (typeof (Sys.WebForms) !== "undefined" && typeof (Sys.WebForms.PageRequestManager) !== "undefined") {
            ...
            if (gbAjaxControlToolkit.ControlBase.__doPostBackSaved == null || typeof gbAjaxControlToolkit.ControlBase.__doPostBackSaved == "undefined") {
                gbAjaxControlToolkit.ControlBase.__doPostBackSaved = window.__doPostBack;
                window.__doPostBack = gbAjaxControlToolkit.ControlBase.__doPostBack;
                gbAjaxControlToolkit.ControlBase.onsubmitCollection = new Array();
            }
    ...
    dispose: function() {
        if (typeof (Sys.WebForms) !== "undefined" && typeof (Sys.WebForms.PageRequestManager) !== "undefined") {
            Array.remove(gbAjaxControlToolkit.ControlBase.onsubmitCollection, this._onsubmit$delegate);
...
gbAjaxControlToolkit.ControlBase.registerClass("gbAjaxControlToolkit.ControlBase", Sys.UI.Control);
...
gbAjaxControlToolkit.AjaxRatingBehavior = function(element) {
    /// <summary>
    ...
    /// </param>
gbAjaxControlToolkit.AjaxRatingBehavior.initializeBase(this, [element]);
...
gbAjaxControlToolkit.AjaxRatingBehavior.prototype = {
    initialize: function() {
        /// <summary>
        /// Initialize the behavior
        /// </summary>
        gbAjaxControlToolkit.AjaxRatingBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function() {
        ...
        gbAjaxControlToolkit.AjaxRatingBehavior.callBaseMethod(this, 'dispose');
    },
...
//        }
    ...
    raiseRated: function(rating) {
        ...
        if (handler) {
            handler(this, new gbAjaxControlToolkit.AjaxRatingEventArgs(rating));
        }
    },
    ...
    raiseMouseOver: function(rating_tmp) {
        ...
        if (handler) {
            handler(this, new gbAjaxControlToolkit.AjaxRatingEventArgs(rating_tmp));
        }
    },
    ...
    raiseMouseOut: function(rating_old) {
        ...
        if (handler) {
            handler(this, new gbAjaxControlToolkit.AjaxRatingEventArgs(rating_old));
        }
    },
    ...
    raiseEndClientCallback: function(result) {
        ...
        if (handler) {
            handler(this, new gbAjaxControlToolkit.AjaxRatingCallbackResultEventArgs(result));
        }
    },
    ...
    get_Rating: function() {
        ...
        /// </value>
        this._ratingValue = gbAjaxControlToolkit.AjaxRatingBehavior.callBaseMethod(this, 'get_ClientState');
    ...
    set_Rating: function(value) {
        ...
        if (this.get_isInitialized()) {
            ...
            gbAjaxControlToolkit.AjaxRatingBehavior.callBaseMethod(this, 'set_ClientState', [this._ratingValue]);
...
gbAjaxControlToolkit.AjaxRatingBehavior.registerClass('gbAjaxControlToolkit.AjaxRatingBehavior', gbAjaxControlToolkit.BehaviorBase);


gbAjaxControlToolkit.AjaxRatingEventArgs = function(rating) {
    /// <summary>
    ...
    /// Rating
    /// </param>
gbAjaxControlToolkit.AjaxRatingEventArgs.initializeBase(this);

    this._rating = rating;
}
gbAjaxControlToolkit.AjaxRatingEventArgs.prototype = {
    get_Rating: function() {
        /// <value type="Number" integer="true">
        /// Rating
        /// </value>
...
gbAjaxControlToolkit.AjaxRatingEventArgs.registerClass('gbAjaxControlToolkit.AjaxRatingEventArgs', Sys.EventArgs);


gbAjaxControlToolkit.AjaxRatingCallbackResultEventArgs = function(result) {
    /// <summary>
    ...
    /// Callback result
    /// </param>
gbAjaxControlToolkit.AjaxRatingCallbackResultEventArgs.initializeBase(this);

    this._result = result;
}
gbAjaxControlToolkit.AjaxRatingCallbackResultEventArgs.prototype = {
