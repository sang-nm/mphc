<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="BingSearchControl.ascx.cs"
    Inherits="CanhCam.Web.UI.BingSearchControl" %>
<asp:UpdatePanel ID="upBing" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Panel ID="pnlBingSearch" runat="server" DefaultButton="btnSearch" CssClass="settingrow search bingsearch">
            ...
            <asp:Button SkinID="DefaultButton" ID="btnSearch" runat="server" />
        ...
        <div class="settingrow">
            <asp:Button SkinID="DefaultButton" ID="btnFirst" runat="server" Visible="false" />
            <asp:Button SkinID="DefaultButton" ID="btnPrevious" runat="server" Visible="false" />
            <asp:Button SkinID="DefaultButton" ID="btnNext" runat="server" Visible="false" />
