<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="OpenIDLoginControl.ascx.cs" Inherits="CanhCam.Web.OpenIdLoginControl" %>

<portal:gbOpenIdLogin ID="OpenIdLogin1" runat="server" CssClass="openid_login" />
<br />
