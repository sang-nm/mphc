<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/DialogMaster.Master"
    CodeBehind="NewsCompare.aspx.cs" Inherits="CanhCam.Web.NewsUI.NewsCompare" %>

<asp:Content ContentPlaceHolderID="phHead" ID="HeadContent" runat="server">
</asp:Content>
<asp:Content ContentPlaceHolderID="phMain" ID="MainContent" runat="server">
    <div style="height: 100%; width: 48%; border-right: solid thin black; float: <%= currentFloat %>;
    ...
    <div style="height: 100%; width: 48%; float: <%= historyFloat %>; padding: 5px 5px 5px 5px;
        overflow: auto;">
        <h1 class="dialogheading htmlcontent">
