...
UrlHelper.prototype.ShowData = function(urlHelper, xmlhttp) {
    ...
    if (xmlDoc) {
        ...
        var message = Sarissa.getText(nWarning, true);
        if (message.length > 0) { urlHelper.warningSpan.innerHTML = message; urlHelper.warningSpan.display = 'inline'; }
		else { urlHelper.warningSpan.display = 'none'; }
    }
}
