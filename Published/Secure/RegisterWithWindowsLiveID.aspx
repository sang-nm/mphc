<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="RegisterWithWindowsLiveID.aspx.cs" Inherits="CanhCam.Web.UI.Pages.RegisterWithWindowsLiveId" %>

<asp:Content ContentPlaceHolderID="leftContent" ID="MPLeftPane" runat="server" />
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <fieldset>
        <legend>
            <gb:SiteLabel ID="lblRegisterLabel" runat="server" ConfigKey="WindowsLiveIDRegistrationHeading"
                UseLabelTag="false" />
        </legend>
        ...
        <asp:Panel ID="pnlRegisterWrapper" runat="server">
            <asp:Panel ID="pnlWindowsLiveLogin" runat="server">
                ...
                <div style="background: white; color: black; font-size: small; width: 350px; padding: 3px 3px 3px 3px;
                    border: dashed thin gray;">
                    <div>
                        <asp:Literal ID="litInstructions" runat="server" />
                    </div>
                    <iframe id="WebAuthControl" name="WebAuthControl" src="<%=Protocol%>login.live.com/controls/WebAuth.htm?appid=<%=WindowsLiveAppId%>&style=font-size%3A+small%3B+font-family%3A+verdana%3B+background%3A+white%3B"
                        width="97px" height="25px" marginwidth="0" marginheight="0" frameborder="0" scrolling="no"
                        style="display: inline; padding: 0px 0px 0px 0px;"></iframe>
                    <span style="vertical-align: top;"></span>
                </div>
            </asp:Panel>
            <asp:Panel ID="pnlWindowsLiveRegister" runat="server">
                <div class="settingrow">
                    <gb:SiteLabel ID="lblLoginName" runat="server" ForControl="txtUserName" CssClass="settinglabel"
                ...
                <div class="settingrow">
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="txtUserName" ID="UserNameRequired"
                ...
                <div>
                    <portal:gbLabel ID="lblMessage" runat="server" CssClass="txterror info" />
                </div>
                <div class="settingrow">
                    <gb:SiteLabel ID="SiteLabel1" runat="server" CssClass="settinglabel" ConfigKey="EmptyLabel">
                    </gb:SiteLabel>
