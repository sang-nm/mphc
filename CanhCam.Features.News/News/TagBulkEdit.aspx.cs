...
namespace CanhCam.Web.NewsUI
{
    public partial class TagBulkEditPage : CmsNonBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!NewsPermission.CanManageTags)
            {
        ...
        private void BindGrid()
        {
            ...
            List<Tag> tags = Tag.GetPage(siteSettings.SiteGuid, News.FeatureGuid, keyword, -1, pageNumber, pageSize);

            string pageUrl = SiteRoot + "/News/TagBulkEdit.aspx";
            if(keyword != null)
            ...
            pgr.ItemCount = Tag.GetCount(siteSettings.SiteGuid, News.FeatureGuid, null, -1);
            ...
            try
            {
                foreach (RepeaterItem item in rpt.Items)
                {
                    if ((item.ItemType == ListItemType.Item || item.ItemType == ListItemType.AlternatingItem))
                    {
                        ...
                        tag.CreatedBy = SiteUtils.GetCurrentSiteUser().UserGuid;
        ...
        {
            Title = SiteUtils.FormatPageTitle(siteSettings, NewsResources.NewsTagsTitle);
            heading.Text = NewsResources.NewsTagsTitle;

            lnkGridView.NavigateUrl = SiteRoot + "/News/TagList.aspx";
        }
        ...
        private void LoadSettings()
        {
            ...
            AddClassToBody("admin-newstags tagbulkedit");
        }
