<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master"
    CodeBehind="TagBulkEdit.aspx.cs" Inherits="CanhCam.Web.NewsUI.TagBulkEditPage" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <portal:BreadcrumbAdmin ID="breadcrumb" runat="server" 
        CurrentPageTitle="<%$Resources:NewsResources, NewsTagsBulkEdit %>" CurrentPageUrl="~/News/TagBulkEdit.aspx"
        ParentTitle="<%$Resources:NewsResources, NewsTagsTitle %>" ParentUrl="~/News/TagList.aspx" />
    <div class="admin-content col-md-12">
        <portal:HeadingPanel ID="heading" runat="server">
            <asp:Button SkinID="InsertButton" ID="btnAddNew" Text="<%$Resources:NewsResources, NewsTagAddNewButton %>" runat="server" />
            ...
            <asp:HyperLink SkinID="DefaultButton" ID="lnkGridView" Text="<%$Resources:NewsResources, NewsTagsTitle %>" runat="server" />
        </portal:HeadingPanel>
        <portal:NotifyMessage ID="message" runat="server" />
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" CssClass="headInfo" runat="server">
            <div class="input-group">
                <asp:TextBox ID="txtKeyword" placeholder="<%$Resources:NewsResources, NewsTagKeywordLabel %>" CssClass="form-control" runat="server" MaxLength="255" />
                <div class="input-group-btn">
                    <asp:Button SkinID="DefaultButton" ID="btnSearch" Text="<%$Resources:NewsResources, NewsSearchButton %>"
                        ...
                        <div class="bulkzone">
                            <div class="settingrow form-group">
                                <gb:SiteLabel ID="lblName" runat="server" ForControl="txtName" CssClass="settinglabel control-label col-sm-3"
                                        ConfigKey="NewsTagName" ResourceFile="NewsResources" />
                                <div class="col-sm-9">
